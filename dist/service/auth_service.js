...
import { find_user_by_loginName, add_customer_with_auth, find_customer_by_loginName, add_user_loginSession, find_base_role, find_merchant_roles, update_user_loginSession, add_customer_loginSession, update_customer_loginSession, invalidate_customer_loginSession, invalidate_user_loginSession } from "../dao/user_dao.js";
import { FailToCheckParam, FailToUpdateToken, FailToVerifyToken, NotFoundUserRole } from "../util/errcode.js";
import { ROLE_CUST, get_session_ttl } from "../util/constants.js";
import { generate_token, verify_token } from "../util/jwtoken.js";
/**
 * Signup (as customer)
 * @param userName
 * @param phoneNumber
