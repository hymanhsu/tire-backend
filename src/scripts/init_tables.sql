...
CREATE UNIQUE INDEX UNIQUE_MANAGER_STAFFS ON manager_staffs (manager, staff);
...
CREATE UNIQUE INDEX UNIQUE_STOCK_ORDER_FLOW ON stock_order_flows (product_sku_id, order_id);
